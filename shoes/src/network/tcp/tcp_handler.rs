...
use crate::network::async_stream::{AsyncMessageStream, AsyncStream, AsyncTargetedMessageStream};
...
pub enum TcpServerSetupResult {
    ...
    SessionBasedUdp {
        need_initial_flush: bool,
        stream: Box<dyn crate::network::async_stream::AsyncSessionMessageStream>,
        /// The proxy selector to use for routing this connection
        proxy_selector: Arc<ClientProxySelector>,
    },
