...
use crate::network::tcp::proxy_connector_impl::ProxyConnectorImpl;
use crate::network::tcp::socket_connector::SocketConnector;
use crate::network::tcp::socket_connector_impl::SocketConnectorImpl;
...
pub fn build_client_proxy_chain(
    client_chain: crate::utils::option::OneOrSome<ClientChainHop>,
...
) -> Option<&'a crate::utils::address::NetLocation> {
...
pub fn build_client_chain_group(
    client_chains: crate::utils::option::NoneOrSome<crate::config::ClientChain>,
    resolver: Arc<dyn Resolver>,
) -> ClientChainGroup {
    let chains: Vec<ClientProxyChain> = if client_chains.is_empty() {
        vec![build_client_proxy_chain(
            crate::utils::option::OneOrSome::One(ClientChainHop::Single(ConfigSelection::Config(
...
mod tests {
    ...
    use crate::utils::resolver::NativeResolver;
