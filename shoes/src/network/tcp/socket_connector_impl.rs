...
//!
//! Handles TCP transport with bind_interface support.
...
use crate::utils::resolver::{Resolver, resolve_single_address};
use crate::network::socket_util::{new_tcp_socket, new_udp_socket, set_tcp_keepalive};
...
/// Implementation of SocketConnector for TCP transport.
///
/// Created from the socket-related fields of any ClientConfig:
/// - `bind_interface`
/// - `transport`
...
impl SocketConnectorImpl {
    ...
    /// * `target_address` - Unused for TCP, kept for API compatibility.
    ///
    /// # Returns
    /// Always Some(Self) as TCP construction doesn't fail here.
    pub fn from_config(
        config: &ClientConfig,
        ...
        // We only support TCP now. Ignore QUIC settings.
        ...
        if matches!(config.transport, Transport::Quic) {
            log::warn!("QUIC transport is not supported in this build, falling back to TCP");
        }
...
impl SocketConnector for SocketConnectorImpl {
    ...
    async fn connect_udp_bidirectional(
        ...
        resolver: &Arc<dyn Resolver>,
        target: NetLocation,
    ) -> std::io::Result<Box<dyn crate::network::async_stream::AsyncMessageStream>> {
        debug!(
...
impl crate::network::async_stream::AsyncReadMessage for UnconnectedUdpSocket {
...
impl crate::network::async_stream::AsyncWriteMessage for UnconnectedUdpSocket {
...
impl crate::network::async_stream::AsyncFlushMessage for UnconnectedUdpSocket {
...
impl crate::network::async_stream::AsyncShutdownMessage for UnconnectedUdpSocket {
...
impl crate::network::async_stream::AsyncPing for UnconnectedUdpSocket {
...
impl crate::network::async_stream::AsyncMessageStream for UnconnectedUdpSocket {}
