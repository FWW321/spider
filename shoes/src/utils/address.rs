...
mod tests {
    ...
    fn test_netlocation_serialization() {
        ...
        let yaml_str = serde_yml::to_string(&net_loc).expect("Failed to serialize NetLocation");
        println!("NetLocation YAML: {yaml_str}");

        let deserialized: NetLocation =
            serde_yml::from_str(&yaml_str).expect("Failed to deserialize NetLocation");
    ...
    fn test_address_mask_serialization() {
        ...
        let yaml_str =
            serde_yml::to_string(&address_mask).expect("Failed to serialize AddressMask");
        println!("AddressMask YAML: {yaml_str}");

        let deserialized: AddressMask =
            serde_yml::from_str(&yaml_str).expect("Failed to deserialize AddressMask");
    ...
    fn test_netlocationmask_serialization() {
        ...
        let yaml_str =
            serde_yml::to_string(&net_location_mask).expect("Failed to serialize NetLocationMask");
        println!("NetLocationMask YAML: {yaml_str}");

        let deserialized: NetLocationMask =
            serde_yml::from_str(&yaml_str).expect("Failed to deserialize NetLocationMask");
